impl DirectWasmCompiler {
    fn intern_string(&mut self, bytes: Vec<u8>) -> (u32, u32) {
...
impl<'a> FunctionCompiler<'a> {
    ...
    fn compile(mut self, statements: &[Statement]) -> DirectResult<CompiledFunction> {
    ...
    fn initialize_parameter_defaults(&mut self) -> DirectResult<()> {
    ...
    fn parameter_scope_arguments_local_for(&self, name: &str) -> Option<u32> {
    ...
    fn emit_parameter_default_binding_read(&mut self, name: &str) -> DirectResult<bool> {
    ...
    fn allocate_named_hidden_local(&mut self, prefix: &str, kind: StaticValueKind) -> String {
    ...
    fn collect_capture_bindings_from_expression(
        &self,
    ...
    fn collect_capture_bindings_from_summary(
        &self,
    ...
    fn resolve_specialized_function_value_from_expression(
        &self,
        expression: &Expression,
    ...
    fn resolve_function_value_template_from_expression(
        &self,
        expression: &Expression,
    ) -> Option<SpecializedFunctionValue> {
    ...
    fn instantiate_specialized_function_value(
        &mut self,
    ...
    fn alias_runtime_binding_metadata(&mut self, target: &str, source: &str) {
    ...
    fn update_local_specialized_function_value(
        &mut self,
        name: &str,
        value: &Expression,
    ) -> DirectResult<()> {
    ...
    fn update_global_specialized_function_value(
        &mut self,
        name: &str,
        value: &Expression,
    ) -> DirectResult<()> {
    ...
    fn update_tracked_array_specialized_function_value(
        &mut self,
        name: &str,
        index: u32,
        value: &Expression,
    ...
    fn resolve_tracked_array_specialized_function_value(
        &self,
        object: &Expression,
        property: &Expression,
    ) -> Option<SpecializedFunctionValue> {
    ...
    fn emit_specialized_callee_call(
        &mut self,
        callee: &Expression,
    ...
    fn ensure_runtime_array_slot_entry(&mut self, name: &str, index: u32) -> RuntimeArraySlot {
        if let Some(slot) = self.runtime_array_slot(name, index) {
            return slot;
        }
    ...
    fn typed_array_oob_local(&mut self, name: &str) -> u32 {
    ...
    fn resolve_array_buffer_binding_from_expression(
        &self,
        expression: &Expression,
    ) -> Option<(usize, usize)> {
    ...
    fn resolve_typed_array_view_binding_from_expression(
        &self,
        expression: &Expression,
    ...
    fn typed_array_view_static_length(&self, view: &TypedArrayViewBinding) -> Option<usize> {
        let buffer = self
            .local_resizable_array_buffer_bindings
    ...
    fn typed_array_view_static_values(
        &self,
    ...
    fn sync_typed_array_view_runtime_state(&mut self, name: &str) -> DirectResult<()> {
    ...
    fn sync_typed_array_views_for_buffer(&mut self, buffer_name: &str) -> DirectResult<()> {
        let names = self
    ...
    fn apply_resizable_array_buffer_resize(
        &mut self,
        name: &str,
        new_length: usize,
    ) -> DirectResult<bool> {
    ...
    fn emit_typed_array_view_write(
        &mut self,
        view_name: &str,
        property: &Expression,
        value: &Expression,
    ...
    fn update_local_resizable_array_buffer_binding(
        &mut self,
        name: &str,
        value: &Expression,
    ) -> DirectResult<()> {
    ...
    fn update_local_typed_array_view_binding(
        &mut self,
        name: &str,
        value: &Expression,
    ) -> DirectResult<()> {
    ...
    fn emit_dynamic_runtime_array_slot_read_from_local(
        &mut self,
        name: &str,
        index_local: u32,
    ) -> DirectResult<bool> {
    ...
    fn register_bindings(&mut self, statements: &[Statement]) -> DirectResult<()> {
    ...
    fn initialize_arguments_object(&mut self, statements: &[Statement]) -> DirectResult<()> {
        ...
        for index in arguments_usage.indexed_slots {
            ...
            let mapped_local = if index < self.visible_param_count {
            ...
            self.arguments_slots.insert(
                ...
                ArgumentsSlot {
                    ...
                    present_local,
                    mapped_local,
                    source_param_local: if index < self.visible_param_count {
                        Some(index)
                    } else {
                        None
                    },
                    state: ArgumentsIndexedPropertyState::data(
                        index < self.visible_param_count,
                        self.mapped_arguments && index < self.visible_param_count,
                    ),
                },
            );
        }
    ...
    fn ensure_arguments_slot(&mut self, index: u32) -> DirectResult<()> {
        ...
        if let Some(source_param_local) = if index < self.visible_param_count {
            Some(index)
        } else {
            self.extra_argument_param_locals.get(&index).copied()
        } {
    ...
    fn emit_statements(&mut self, statements: &[Statement]) -> DirectResult<()> {
        for statement in statements {
    ...
    fn emit_statements_in_direct_lexical_scope(
        &mut self,
    ...
    fn with_active_eval_lexical_scope<T>(
        &mut self,
        names: Vec<String>,
    ...
    fn push_active_eval_lexical_scope(&mut self, names: Vec<String>) {
    ...
    fn pop_active_eval_lexical_scope(&mut self) {
    ...
    fn emit_statement(&mut self, statement: &Statement) -> DirectResult<()> {
        match statement {
            ...
            Statement::Var { name, value } | Statement::Let { name, value, .. } => {
                ...
                if let Statement::Let { .. } = statement
            ...
            Statement::If {
                ...
                {
                    self.with_narrowed_local_binding_metadata(
                        &name,
                        &narrowed_expression,
            ...
            Statement::With { object, body } => {
                ...
                self.instructions.push(0x1a);
                self.with_scopes
                    .push(self.canonicalize_with_scope_expression(object));
    ...
    fn emit_throw_from_locals(&mut self) -> DirectResult<()> {
        self.push_local_get(self.throw_value_local);
    ...
    fn emit_labeled_block(&mut self, labels: &[String], body: &[Statement]) -> DirectResult<()> {
        self.instructions.push(0x02);
        self.instructions.push(EMPTY_BLOCK_TYPE);
        let break_target = self.push_control_frame();
        self.break_stack.push(BreakContext {
    ...
    fn emit_check_global_throw_for_user_call(&mut self) -> DirectResult<()> {
        self.push_global_get(THROW_TAG_GLOBAL_INDEX);
        self.push_i32_const(0);
        self.push_binary_op(BinaryOp::NotEqual)?;
        self.instructions.push(0x04);
    ...
    fn clear_local_throw_state(&mut self) {
        self.push_i32_const(0);
        self.push_local_set(self.throw_tag_local);
        self.push_i32_const(0);
        self.push_local_set(self.throw_value_local);
    ...
    fn clear_global_throw_state(&mut self) {
        self.push_i32_const(0);
        self.push_global_set(THROW_TAG_GLOBAL_INDEX);
        self.push_i32_const(0);
        self.push_global_set(THROW_VALUE_GLOBAL_INDEX);
    ...
    fn emit_error_throw(&mut self) -> DirectResult<()> {
    ...
    fn emit_named_error_throw(&mut self, name: &str) -> DirectResult<()> {
    ...
    fn emit_static_throw_value(&mut self, throw_value: &StaticThrowValue) -> DirectResult<()> {
        match throw_value {
    ...
    fn emit_static_eval_outcome(&mut self, outcome: &StaticEvalOutcome) -> DirectResult<()> {
        match outcome {
    ...
    fn conditional_defined_binding_narrowing(
        &self,
        condition: &Expression,
        then_branch: bool,
    ...
    fn with_narrowed_local_binding_metadata<T>(
        &mut self,
        name: &str,
        expression: &Expression,
    ...
    fn has_arguments_object(&self) -> bool {
        self.actual_argument_count_local.is_some()
    }

    fn emit_arguments_length(&mut self) {
        if let Some(actual_argument_count_local) = self.actual_argument_count_local {
            self.push_local_get(actual_argument_count_local);
        } else {
            self.push_i32_const(0);
    ...
    fn emit_arguments_slot_data_read(&mut self, slot: &ArgumentsSlot) {
    ...
    fn emit_arguments_slot_accessor_call(
        &mut self,
        callee: &Expression,
        argument_locals: &[u32],
    ...
    fn capture_arguments_slot_value(&mut self, slot: &ArgumentsSlot) {
        self.emit_arguments_slot_data_read(slot);
        self.push_local_set(slot.value_local);
    }

    fn emit_arguments_slot_read(&mut self, index: u32) -> DirectResult<()> {
    ...
    fn emit_arguments_slot_write_from_local(
        &mut self,
        index: u32,
        value_local: u32,
    ) -> DirectResult<()> {
    ...
    fn emit_arguments_slot_write(&mut self, index: u32, value: &Expression) -> DirectResult<()> {
        self.ensure_arguments_slot(index)?;
    ...
    fn emit_runtime_array_iterator_value_from_local(
        &mut self,
        index_local: u32,
    ...
    fn emit_arguments_slot_delete(&mut self, index: u32) {
        if let Some(slot) = self.arguments_slots.get(&index).cloned() {
    ...
    fn resolve_user_function_from_callee_name(&self, name: &str) -> Option<&UserFunction> {
    ...
    fn resolve_returned_member_value_from_expression(
        &self,
        object: &Expression,
        property: &Expression,
    ) -> Option<Expression> {
    ...
    fn resolve_returned_object_binding_from_call(
        &self,
        callee: &Expression,
        arguments: &[CallArgument],
    ...
    fn substitute_user_function_argument_bindings(
        &self,
        expression: &Expression,
    ...
    fn substitute_user_function_call_frame_bindings(
        &self,
        expression: &Expression,
        user_function: &UserFunction,
        arguments: &[CallArgument],
    ...
    fn substitute_call_frame_special_bindings(
        &self,
        expression: &Expression,
        user_function: &UserFunction,
        this_binding: &Expression,
    ...
    fn emit_inline_user_function_summary_with_explicit_call_frame(
        &mut self,
        user_function: &UserFunction,
    ...
    fn resolve_function_binding_static_return_expression_with_call_frame(
        &self,
    ...
    fn resolve_inline_call_from_returned_member(
        &self,
        object: &Expression,
        property: &Expression,
        arguments: &[CallArgument],
    ...
    fn is_direct_arguments_object(&self, expression: &Expression) -> bool {
        match expression {
    ...
    fn emit_inline_user_function_summary_with_arguments(
        &mut self,
        user_function: &UserFunction,
        arguments: &[Expression],
    ) -> DirectResult<bool> {
    ...
    fn emit_inline_user_function_summary_with_argument_locals(
        &mut self,
        user_function: &UserFunction,
        argument_locals: &[u32],
        argument_count: usize,
    ...
    fn emit_inline_summary_with_call_arguments(
        &mut self,
        user_function: &UserFunction,
        summary: &InlineFunctionSummary,
    ...
    fn emit_specialized_function_value_call(
        &mut self,
    ...
    fn inline_safe_argument_expression(&self, expression: &Expression) -> bool {
    ...
    fn can_inline_user_function_call(
        &self,
        user_function: &UserFunction,
        arguments: &[Expression],
    ) -> bool {
    ...
    fn user_function_has_inlineable_terminal_body(&self, user_function: &UserFunction) -> bool {
    ...
    fn inline_argument_mentions_shadowed_implicit_global(&self, expression: &Expression) -> bool {
        match expression {
            Expression::Identifier(name) => {
    ...
    fn emit_delete_result_or_throw_if_strict(&mut self) -> DirectResult<()> {
        if !self.strict_mode {
            return Ok(());
        }
    ...
    fn user_function_references_captured_user_function(
        &self,
        user_function: &UserFunction,
    ) -> bool {
    ...
    fn direct_arguments_callee_expression(&self) -> Option<Expression> {
    ...
    fn direct_arguments_has_property(&self, property_name: &str) -> bool {
        match property_name {
    ...
    fn apply_direct_arguments_define_property(
        &mut self,
        index: u32,
    ...
    fn emit_direct_arguments_length(&mut self) -> DirectResult<()> {
    ...
    fn emit_direct_arguments_callee(&mut self) -> DirectResult<()> {
        if self.strict_mode {
    ...
    fn emit_dynamic_arguments_binding_property_read(
        &mut self,
    ...
    fn emit_dynamic_direct_arguments_property_read_from_local(
        &mut self,
        property_local: u32,
    ) -> DirectResult<()> {
        let mut open_frames = 0;
    ...
    fn emit_dynamic_direct_arguments_property_read(
        &mut self,
        property: &Expression,
    ) -> DirectResult<()> {
        let property_local = self.allocate_temp_local();
    ...
    fn emit_dynamic_direct_arguments_property_write(
        &mut self,
        property: &Expression,
        value: &Expression,
    ) -> DirectResult<()> {
    ...
    fn apply_current_arguments_effect(
        &mut self,
        property_name: &str,
    ...
    fn update_named_arguments_binding_effect(
        &mut self,
        object: &Expression,
        property_name: &str,
        effect: ArgumentsPropertyEffect,
    ...
    fn emit_print(&mut self, values: &[Expression]) -> DirectResult<()> {
    ...
    fn emit_print_value(&mut self, value: &Expression) -> DirectResult<()> {
        match value {
    ...
    fn emit_runtime_print_numeric_value(&mut self, value: &Expression) -> DirectResult<()> {
        let value_local = self.allocate_temp_local();
        self.emit_numeric_expression(value)?;
        self.push_local_set(value_local);
        self.push_local_get(value_local);
    ...
    fn resolve_static_string_value(&self, expression: &Expression) -> Option<String> {
    ...
    fn resolve_static_string_value_with_context(
        &self,
        expression: &Expression,
    ...
    fn resolve_static_string_concat_value(
        &self,
        expression: &Expression,
        current_function_name: Option<&str>,
    ) -> Option<String> {
    ...
    fn emit_numeric_expression(&mut self, expression: &Expression) -> DirectResult<()> {
        match expression {
            Expression::Number(value) => {
                if value.is_nan() {
                    self.push_i32_const(JS_NAN_TAG);
    ...
    fn emit_assert_compare_array_call(&mut self, arguments: &[CallArgument]) -> DirectResult<bool> {
        let [
    ...
    fn emit_runtime_assert_compare_array_against_expected(
        &mut self,
        actual: &Expression,
    ...
    fn emit_object_set_prototype_of_call(
        &mut self,
    ...
    fn emit_compare_array_call(&mut self, arguments: &[CallArgument]) -> DirectResult<bool> {
        let [
            CallArgument::Expression(actual),
            CallArgument::Expression(expected),
            rest @ ..,
    ...
    fn emit_object_array_builtin_call(
        &mut self,
        callee_object: &Expression,
        callee_property: &Expression,
        arguments: &[CallArgument],
    ...
    fn emit_function_constructor_builtin_call(
        &mut self,
        name: &str,
        arguments: &[CallArgument],
    ) -> DirectResult<bool> {
    ...
    fn emit_test262_realm_eval_call(
        &mut self,
        builtin_name: &str,
        arguments: &[CallArgument],
    ) -> DirectResult<bool> {
    ...
    fn emit_builtin_call(&mut self, name: &str, arguments: &[CallArgument]) -> DirectResult<bool> {
        if matches!(
            name,
            "__assert" | "__assertSameValue" | "__assertNotSameValue"
        ) {
        ...
        let Some(result_tag) = (match name {
            ...
            | "AggregateError" | "Promise" => Some(JS_TYPEOF_OBJECT_TAG),
    ...
    fn emit_is_nan_call(&mut self, arguments: &[CallArgument]) -> DirectResult<bool> {
    ...
    fn emit_assert_throws_call(&mut self, arguments: &[CallArgument]) -> DirectResult<bool> {
        let [
    ...
    fn emit_assert_throws_statement(&mut self, expression: &Expression) -> DirectResult<bool> {
    ...
    fn emit_assertion_builtin_call(
        &mut self,
        name: &str,
        arguments: &[CallArgument],
    ) -> DirectResult<bool> {
    ...
    fn resolve_static_same_value_result_with_context(
        &self,
        actual: &Expression,
        expected: &Expression,
        current_function_name: Option<&str>,
    ...
    fn resolve_static_reference_identity_key(&self, expression: &Expression) -> Option<String> {
    ...
    fn reference_identity_key_for_identifier(&self, name: &str) -> Option<String> {
    ...
    fn emit_same_value_result_from_locals(
        &mut self,
        actual_local: u32,
        expected_local: u32,
        result_local: u32,
    ...
    fn emit_verify_property_call(&mut self, arguments: &[CallArgument]) -> DirectResult<bool> {
    ...
    fn resolve_static_number_value(&self, expression: &Expression) -> Option<f64> {
        if let Expression::Identifier(name) = expression
            && name == "Infinity"
    ...
    fn resolve_static_bigint_value(&self, expression: &Expression) -> Option<StaticBigInt> {
        let materialized = self.materialize_static_expression(expression);
        if !static_expression_matches(&materialized, expression) {
    ...
    fn resolve_static_boolean_expression(&self, expression: &Expression) -> Option<bool> {
        let materialized = self.materialize_static_expression(expression);
        match materialized {
    ...
    fn resolve_static_is_nan_call_result(&self, expression: &Expression) -> Option<bool> {
        let Expression::Call { callee, arguments } = expression else {
            return None;
        };
    ...
    fn resolve_static_has_own_property_call_result(&self, expression: &Expression) -> Option<bool> {
        let Expression::Call { callee, arguments } = expression else {
            return None;
        };
        let Expression::Member { object, property } = callee.as_ref() else {
    ...
    fn resolve_static_object_is_call_result(&self, expression: &Expression) -> Option<bool> {
        let Expression::Call { callee, arguments } = expression else {
            return None;
        };
        let Expression::Member { object, property } = callee.as_ref() else {
    ...
    fn canonical_object_property_expression(&self, property: &Expression) -> Expression {
    ...
    fn resolve_object_binding_property_value(
        &self,
    ...
    fn resolve_static_if_condition_value(&self, expression: &Expression) -> Option<bool> {
    ...
    fn emit_static_string_equality_comparison(
        &mut self,
        left: &Expression,
        right: &Expression,
        op: BinaryOp,
    ...
    fn static_expressions_equal(&self, actual: &Expression, expected: &Expression) -> bool {
    ...
    fn expand_call_arguments(&self, arguments: &[CallArgument]) -> Vec<Expression> {
    ...
    fn emit_dynamic_user_function_call(
        &mut self,
        callee: &Expression,
        arguments: &[CallArgument],
    ) -> DirectResult<bool> {
    ...
    fn emit_user_function_call_with_new_target(
        &mut self,
        user_function: &UserFunction,
        arguments: &[CallArgument],
    ...
    fn emit_user_function_call_with_new_target_and_this(
        &mut self,
        user_function: &UserFunction,
        arguments: &[CallArgument],
        new_target_value: i32,
    ...
    fn emit_user_function_call_without_inline_with_new_target_and_this(
        &mut self,
        user_function: &UserFunction,
        arguments: &[CallArgument],
        new_target_value: i32,
    ...
    fn emit_prepared_user_function_call_with_new_target_and_this(
        &mut self,
        user_function: &UserFunction,
    ...
    fn emit_user_function_call_with_new_target_and_this_expression(
        &mut self,
        user_function: &UserFunction,
        arguments: &[CallArgument],
        new_target_value: i32,
    ...
    fn expand_apply_call_arguments_from_expression(
        &self,
        expression: &Expression,
    ...
    fn emit_function_prototype_call_or_apply(
        &mut self,
        object: &Expression,
        property: &Expression,
        arguments: &[CallArgument],
    ...
    fn prepare_user_function_capture_bindings(
        &mut self,
        user_function: &UserFunction,
    ...
    fn emit_prepare_user_function_capture_globals(
        &mut self,
        function_name: &str,
    ) -> DirectResult<()> {
        let Some(capture_bindings) = self
    ...
    fn user_function_capture_source_is_locally_bound(&self, name: &str) -> bool {
    ...
    fn clear_user_function_capture_static_metadata(&mut self, hidden_name: &str) {
    ...
    fn sync_user_function_capture_static_metadata(&mut self, source_name: &str, hidden_name: &str) {
    ...
    fn restore_user_function_capture_bindings(&mut self, prepared: &[PreparedCaptureBinding]) {
    ...
    fn emit_user_function_construct(
        &mut self,
        user_function: &UserFunction,
        arguments: &[CallArgument],
    ) -> DirectResult<bool> {
    ...
    fn resolve_user_function_from_expression(
        &self,
        expression: &Expression,
    ) -> Option<&UserFunction> {
    ...
    fn is_restricted_arrow_function_property(
        &self,
        object: &Expression,
        property: &Expression,
    ) -> bool {
    ...
    fn resolve_function_binding_from_expression_with_context(
        &self,
        expression: &Expression,
        current_function_name: Option<&str>,
    ) -> Option<LocalFunctionBinding> {
    ...
    fn resolve_test262_realm_id_from_expression(&self, expression: &Expression) -> Option<u32> {
        match expression {
            Expression::Identifier(name) => {
    ...
    fn resolve_test262_realm_global_id_from_expression(
        &self,
        expression: &Expression,
    ) -> Option<u32> {
        let materialized = self.materialize_static_expression(expression);
    ...
    fn prepare_special_assignment_expression(
        &mut self,
        expression: &Expression,
    ) -> Option<Expression> {
        match expression {
    ...
    fn member_function_binding_key(
        &self,
        object: &Expression,
        property: &Expression,
    ...
    fn member_function_binding_property(
        &self,
        property: &Expression,
    ...
    fn resolve_primitive_property_key_expression(
        &self,
        expression: &Expression,
    ) -> Option<Expression> {
        let materialized = self.materialize_static_expression(expression);
    ...
    fn well_known_symbol_name(&self, expression: &Expression) -> Option<String> {
    ...
    fn resolve_property_key_from_function_binding(
        &self,
        binding: &LocalFunctionBinding,
    ) -> Option<Expression> {
        let LocalFunctionBinding::User(function_name) = binding else {
    ...
    fn resolve_property_key_coercion_from_object_binding(
        &self,
        object_binding: &ObjectValueBinding,
    ...
    fn resolve_property_key_expression_with_coercion(
        &self,
        expression: &Expression,
    ...
    fn resolve_property_key_expression(&self, expression: &Expression) -> Option<Expression> {
        self.resolve_property_key_expression_with_coercion(expression)
            .map(|resolved| resolved.key)
    }

    fn resolve_registered_function_declaration(
        &self,
        function_name: &str,
    ...
    fn resolve_static_function_outcome_from_binding_with_context(
        &self,
        binding: &LocalFunctionBinding,
        arguments: &[CallArgument],
    ...
    fn resolve_static_date_timestamp(&self, expression: &Expression) -> Option<f64> {
        let resolved = self.resolve_bound_alias_expression(expression)?;
    ...
    fn synthesize_static_date_string(&self, timestamp: f64) -> String {
    ...
    fn synthesize_static_function_to_string(&self, function_name: &str) -> String {
    ...
    fn resolve_static_symbol_to_string_value_with_context(
        &self,
        expression: &Expression,
        current_function_name: Option<&str>,
    ) -> Option<String> {
    ...
    fn resolve_static_boxed_primitive_value(&self, expression: &Expression) -> Option<Expression> {
        let resolved = self
            .resolve_bound_alias_expression(expression)
            .unwrap_or_else(|| expression.clone());
    ...
    fn resolve_static_symbol_to_primitive_outcome_with_context(
        &self,
        expression: &Expression,
        current_function_name: Option<&str>,
    ) -> Option<StaticEvalOutcome> {
    ...
    fn symbol_to_primitive_requires_runtime_with_context(
        &self,
        expression: &Expression,
        current_function_name: Option<&str>,
    ) -> bool {
    ...
    fn resolve_static_member_call_outcome_with_context(
        &self,
        object: &Expression,
        property_name: &str,
        current_function_name: Option<&str>,
    ...
    fn resolve_static_to_primitive_outcome_with_context(
        &self,
        expression: &Expression,
        hint: PrimitiveHint,
        current_function_name: Option<&str>,
    ...
    fn resolve_static_addition_outcome_with_context(
        &self,
        left: &Expression,
        right: &Expression,
        current_function_name: Option<&str>,
    ...
    fn addition_operand_requires_runtime_value(&self, expression: &Expression) -> bool {
        match expression {
            Expression::Identifier(name) => {
    ...
    fn resolve_static_string_addition_value_with_context(
        &self,
        left: &Expression,
        right: &Expression,
        current_function_name: Option<&str>,
    ...
    fn emit_property_key_expression_effects(
        &mut self,
        expression: &Expression,
    ...
    fn resolve_function_binding_static_return_expression(
        &self,
        binding: &LocalFunctionBinding,
        arguments: &[Expression],
    ) -> Option<Expression> {
    ...
    fn resolve_function_binding_static_return_bool(
        &self,
        binding: &LocalFunctionBinding,
        arguments: &[Expression],
    ) -> Option<bool> {
    ...
    fn resolve_function_binding_static_return_object_binding(
        &self,
        binding: &LocalFunctionBinding,
        arguments: &[Expression],
    ) -> Option<ObjectValueBinding> {
    ...
    fn emit_function_binding_side_effects_with_arguments(
        &mut self,
        binding: &LocalFunctionBinding,
        arguments: &[Expression],
    ) -> DirectResult<()> {
    ...
    fn function_binding_defaults_to_undefined(&self, binding: &LocalFunctionBinding) -> bool {
        let LocalFunctionBinding::User(function_name) = binding else {
            return false;
        };
        self.module
    ...
    fn function_binding_always_throws(&self, binding: &LocalFunctionBinding) -> bool {
        let LocalFunctionBinding::User(function_name) = binding else {
            return false;
        };
    ...
    fn resolve_terminal_function_outcome_from_binding(
        &self,
        binding: &LocalFunctionBinding,
        arguments: &[Expression],
    ) -> Option<StaticEvalOutcome> {
    ...
    fn resolve_terminal_call_expression_outcome(
        &self,
        expression: &Expression,
    ) -> Option<StaticEvalOutcome> {
        let Expression::Call { callee, arguments } = expression else {
    ...
    fn resolve_effectful_returned_object_binding(
        &self,
        expression: &Expression,
    ) -> Option<ObjectValueBinding> {
        let (callee, arguments) = match expression {
    ...
    fn resolve_ordinary_to_primitive_plan(
        &self,
        expression: &Expression,
    ...
    fn static_expression_is_non_object_primitive(&self, expression: &Expression) -> Option<bool> {
    ...
    fn emit_ordinary_to_primitive_from_plan(
        &mut self,
        expression: &Expression,
        plan: &OrdinaryToPrimitivePlan,
        result_local: u32,
    ...
    fn emit_effectful_ordinary_to_primitive_addition(
        &mut self,
        left: &Expression,
        right: &Expression,
    ) -> DirectResult<bool> {
    ...
    fn emit_effectful_symbol_to_primitive_for_operand(
        &mut self,
        expression: &Expression,
    ...
    fn emit_effectful_symbol_to_primitive_addition(
        &mut self,
        left: &Expression,
        right: &Expression,
    ) -> DirectResult<bool> {
    ...
    fn with_suspended_with_scopes<T>(
        &mut self,
    ...
    fn resolve_member_function_binding(
        &self,
        object: &Expression,
        property: &Expression,
    ) -> Option<LocalFunctionBinding> {
    ...
    fn resolve_member_getter_binding(
        &self,
        object: &Expression,
        property: &Expression,
    ) -> Option<LocalFunctionBinding> {
    ...
    fn resolve_member_setter_binding(
        &self,
        object: &Expression,
        property: &Expression,
    ) -> Option<LocalFunctionBinding> {
    ...
    fn resolve_proxy_has_binding_from_handler(
        &self,
        handler: &Expression,
    ) -> Option<LocalFunctionBinding> {
    ...
    fn resolve_proxy_binding_from_expression(
        &self,
        expression: &Expression,
    ...
    fn update_local_proxy_binding(&mut self, name: &str, value: &Expression) {
    ...
    fn resolve_eval_local_function_hidden_name(&self, name: &str) -> Option<String> {
    ...
    fn resolve_user_function_capture_hidden_name(&self, name: &str) -> Option<String> {
        let current_function_name = self.current_user_function_name.as_deref()?;
        let bindings = self
            .module
            .user_function_capture_bindings
    ...
    fn emit_eval_local_function_binding_read(&mut self, name: &str) -> DirectResult<bool> {
    ...
    fn emit_user_function_capture_binding_read(&mut self, name: &str) -> DirectResult<bool> {
    ...
    fn emit_store_user_function_capture_binding_from_local(
        &mut self,
        name: &str,
        value_local: u32,
    ) -> DirectResult<bool> {
    ...
    fn emit_store_eval_local_function_binding_from_local(
        &mut self,
        name: &str,
        value_local: u32,
    ) -> DirectResult<bool> {
    ...
    fn emit_delete_eval_local_function_binding(&mut self, name: &str) -> DirectResult<bool> {
        let Some(hidden_name) = self.resolve_eval_local_function_hidden_name(name) else {
            return Ok(false);
        };
        let Some(binding) = self
    ...
    fn emit_typeof_eval_local_function_binding(&mut self, name: &str) -> DirectResult<bool> {
        let Some(hidden_name) = self.resolve_eval_local_function_hidden_name(name) else {
            return Ok(false);
        };
        let Some(binding) = self
    ...
    fn emit_typeof_user_function_capture_binding(&mut self, name: &str) -> DirectResult<bool> {
        let Some(hidden_name) = self.resolve_user_function_capture_hidden_name(name) else {
            return Ok(false);
        };
        let Some(binding) = self
    ...
    fn clear_eval_local_function_binding_metadata(&mut self, name: &str) {
        self.local_value_bindings.remove(name);
        self.local_function_bindings.remove(name);
        self.local_kinds.remove(name);
    }

    fn canonicalize_with_scope_expression(&self, expression: &Expression) -> Expression {
        match expression {
    ...
    fn scope_object_has_binding_property(&self, scope_object: &Expression, name: &str) -> bool {
    ...
    fn emit_with_scope_unscopables_block_check(
        &mut self,
    ...
    fn resolve_with_scope_binding(&mut self, name: &str) -> DirectResult<Option<Expression>> {
    ...
    fn resolve_current_local_binding(&self, name: &str) -> Option<(String, u32)> {
    ...
    fn emit_eval_lexical_binding_read(&mut self, name: &str) -> DirectResult<bool> {
    ...
    fn emit_plain_identifier_read_fallback(&mut self, name: &str) -> DirectResult<()> {
    ...
    fn emit_plain_identifier_read(&mut self, name: &str) -> DirectResult<()> {
    ...
    fn emit_store_implicit_global_from_local(
        &mut self,
    ...
    fn emit_object_spread_copy_data_properties_effects(
        &mut self,
        expression: &Expression,
    ) -> DirectResult<()> {
    ...
    fn resolve_user_function_length(
        &self,
        object: &Expression,
        property: &Expression,
    ) -> Option<u32> {
    ...
    fn runtime_user_function_property_value(
        &self,
        user_function: &UserFunction,
        property_name: &str,
    ) -> Option<Expression> {
    ...
    fn emit_runtime_user_function_property_read(
        &mut self,
        object: &Expression,
        property: &Expression,
    ) -> DirectResult<bool> {
    ...
    fn resolve_function_name_value(
        &self,
        object: &Expression,
        property: &Expression,
    ) -> Option<String> {
    ...
    fn resolve_typed_array_builtin_bytes_per_element(
        &self,
        object: &Expression,
        property: &Expression,
    ) -> Option<u32> {
    ...
    fn emit_member_read_without_prelude(
        &mut self,
        object: &Expression,
        property: &Expression,
    ) -> DirectResult<()> {
    ...
    fn emit_scoped_property_store_from_local(
        &mut self,
        scope_object: &Expression,
        name: &str,
        value_local: u32,
    ...
    fn emit_scoped_property_update(
        &mut self,
        scope_object: &Expression,
        name: &str,
        op: UpdateOp,
    ...
    fn resolve_home_object_name_for_function(&self, function_name: &str) -> Option<String> {
    ...
    fn resolve_super_base_expression_with_context(
        &self,
        current_function_name: Option<&str>,
    ) -> Option<Expression> {
    ...
    fn resolve_super_runtime_prototype_binding_with_context(
        &self,
        current_function_name: Option<&str>,
    ...
    fn emit_runtime_super_property_value_from_base(
        &mut self,
    ...
    fn emit_super_member_read_via_runtime_prototype_binding(
        &mut self,
        property: &Expression,
    ) -> DirectResult<bool> {
    ...
    fn resolve_super_function_binding(
        &self,
        property: &Expression,
    ) -> Option<LocalFunctionBinding> {
    ...
    fn resolve_super_function_binding_with_context(
        &self,
        property: &Expression,
        current_function_name: Option<&str>,
    ) -> Option<LocalFunctionBinding> {
    ...
    fn resolve_super_getter_binding(&self, property: &Expression) -> Option<LocalFunctionBinding> {
    ...
    fn resolve_super_value_expression(&self, property: &Expression) -> Option<Expression> {
        let base = self.resolve_super_base_expression_with_context(
            self.current_user_function_name.as_deref(),
        )?;
        let materialized_property = self.materialize_static_expression(property);
    ...
    fn binding_name_is_global(&self, name: &str) -> bool {
        self.top_level_function
            && self.module.global_bindings.contains_key(name)
            && !self.locals.contains_key(name)
    }

    fn binding_key_is_global(&self, key: &MemberFunctionBindingKey) -> bool {
        match &key.target {
    ...
    fn resolve_named_function_binding_from_descriptor_expression(
        &self,
    ...
    fn resolve_function_binding_from_descriptor_expression(
        &self,
        descriptor: &Expression,
    ) -> Option<LocalFunctionBinding> {
    ...
    fn resolve_getter_binding_from_descriptor_expression(
        &self,
        descriptor: &Expression,
    ) -> Option<LocalFunctionBinding> {
    ...
    fn resolve_setter_binding_from_descriptor_expression(
        &self,
        descriptor: &Expression,
    ) -> Option<LocalFunctionBinding> {
    ...
    fn update_member_function_binding_from_expression(&mut self, expression: &Expression) {
        let Expression::Call { callee, arguments } = expression else {
            return;
        };
        let Expression::Member { object, property } = callee.as_ref() else {
    ...
    fn update_member_function_assignment_binding(
        &mut self,
        object: &Expression,
        property: &Expression,
        value: &Expression,
    ...
    fn update_local_function_binding(&mut self, name: &str, value: &Expression) {
    ...
    fn clear_member_function_bindings_for_name(&mut self, name: &str) {
    ...
    fn clear_object_literal_member_bindings_for_name(&mut self, name: &str) {
        self.member_function_bindings.retain(|key, _| {
    ...
    fn inherited_member_function_bindings(
        &self,
        value: &Expression,
    ) -> Vec<ReturnedMemberFunctionBinding> {
        match value {
    ...
    fn copy_member_bindings_for_alias(&mut self, name: &str, source_name: &str) {
    ...
    fn update_member_function_bindings_for_value(&mut self, name: &str, value: &Expression) {
    ...
    fn update_object_literal_member_bindings_for_value(&mut self, name: &str, value: &Expression) {
        let Expression::Object(entries) = value else {
            return;
        };
    ...
    fn resolve_arguments_callee_strictness(&self, expression: &Expression) -> Option<bool> {
        let Expression::Member { object, property } = expression else {
            return None;
        };
    ...
    fn resolve_arguments_binding_from_expression(
        &self,
        expression: &Expression,
    ...
    fn resolve_array_slice_binding(
        &self,
        object: &Expression,
        arguments: &[CallArgument],
    ) -> Option<ArrayValueBinding> {
    ...
    fn resolve_array_binding_from_expression(
        &self,
        expression: &Expression,
    ) -> Option<ArrayValueBinding> {
        if let Expression::Identifier(name) = expression {
    ...
    fn evaluate_simple_static_expression_with_bindings(
        &self,
        expression: &Expression,
        bindings: &HashMap<String, Expression>,
    ) -> Option<Expression> {
    ...
    fn execute_simple_static_user_function_with_bindings(
        &self,
        function_name: &str,
        bindings: &HashMap<String, Expression>,
    ...
    fn analyze_simple_generator_function(
        &self,
        function_name: &str,
    ...
    fn analyze_simple_generator_statements(
        &self,
        statements: &[Statement],
    ...
    fn substitute_simple_generator_statement_call_frame_bindings(
        &self,
        statement: &Statement,
        user_function: &UserFunction,
        this_binding: &Expression,
    ...
    fn resolve_array_prototype_simple_generator_source(
        &self,
        expression: &Expression,
    ) -> Option<(Vec<SimpleGeneratorStep>, Vec<Statement>)> {
        let materialized = self.materialize_static_expression(expression);
            ...
            .is_some()
        {
            ...
            Expression::Array(
                array_binding
                    ...
                    .into_iter()
                    .map(|value| {
                        crate::ir::hir::ArrayElement::Expression(value.unwrap_or(Expression::Undefined))
                    })
                    .collect(),
            )
        } else {
    ...
    fn resolve_simple_generator_source(
        &self,
        expression: &Expression,
    ) -> Option<(Vec<SimpleGeneratorStep>, Vec<Statement>)> {
        let materialized = self.materialize_static_expression(expression);
    ...
    fn analyze_effectful_iterator_source_call(
        &self,
        expression: &Expression,
    ...
    fn resolve_static_iterable_binding_from_expression(
        &self,
        expression: &Expression,
    ) -> Option<ArrayValueBinding> {
        let object_binding = self.resolve_object_binding_from_expression(expression)?;
    ...
    fn resolve_object_binding_from_expression(
        &self,
        expression: &Expression,
    ) -> Option<ObjectValueBinding> {
        let binding = match expression {
    ...
    fn resolve_copy_data_properties_binding_with_state(
        &self,
        expression: &Expression,
        local_bindings: &mut HashMap<String, Expression>,
        value_bindings: &mut HashMap<String, Expression>,
    ...
    fn resolve_member_getter_value_with_state(
        &self,
        object: &Expression,
        property: &Expression,
        local_bindings: &mut HashMap<String, Expression>,
    ...
    fn assign_static_expression_with_state(
        &self,
        name: &str,
        value: Expression,
        local_bindings: &mut HashMap<String, Expression>,
    ...
    fn assign_static_member_expression_with_state(
        &self,
        object: &Expression,
        property: Expression,
        value: Expression,
    ...
    fn resolve_stateful_object_binding_name_with_state(
        &self,
        expression: &Expression,
        local_bindings: &HashMap<String, Expression>,
        value_bindings: &HashMap<String, Expression>,
    ...
    fn resolve_object_binding_from_expression_with_state(
        &self,
        expression: &Expression,
        local_bindings: &HashMap<String, Expression>,
        value_bindings: &mut HashMap<String, Expression>,
    ...
    fn resolve_enumerated_keys_binding(
        &self,
        expression: &Expression,
    ) -> Option<ArrayValueBinding> {
        if let Some(array_binding) = self.resolve_array_binding_from_expression(expression) {
    ...
    fn resolve_own_property_names_binding(
        &self,
        expression: &Expression,
    ) -> Option<ArrayValueBinding> {
        if let Some(array_binding) = self.resolve_array_binding_from_expression(expression) {
    ...
    fn resolve_own_property_symbols_binding(
        &self,
        expression: &Expression,
    ) -> Option<ArrayValueBinding> {
        let object_binding = self.resolve_object_binding_from_expression(expression)?;
    ...
    fn resolve_builtin_array_call_binding(
        &self,
        callee: &Expression,
        arguments: &[CallArgument],
    ) -> Option<ArrayValueBinding> {
    ...
    fn materialize_static_expression(&self, expression: &Expression) -> Expression {
    ...
    fn ensure_runtime_array_length_local(&mut self, name: &str) -> u32 {
    ...
    fn resolve_runtime_array_binding_name(&self, name: &str) -> Option<String> {
        if self.local_array_bindings.contains_key(name)
    ...
    fn resolve_local_array_iterator_binding_name(&self, name: &str) -> Option<String> {
    ...
    fn runtime_array_length_local_for_expression(&self, expression: &Expression) -> Option<u32> {
    ...
    fn ensure_runtime_array_slots_for_binding(&mut self, name: &str, binding: &ArrayValueBinding) {
        for index in 0..TRACKED_ARRAY_SLOT_LIMIT {
    ...
    fn runtime_array_slot(&self, name: &str, index: u32) -> Option<RuntimeArraySlot> {
        self.runtime_array_slots
            .get(name)
    ...
    fn emit_runtime_array_slot_read(&mut self, name: &str, index: u32) -> DirectResult<bool> {
        let binding_name = self
            .resolve_runtime_array_binding_name(name)
            .unwrap_or_else(|| name.to_string());
    ...
    fn emit_runtime_array_slot_write_from_local(
        &mut self,
        name: &str,
        index: u32,
        value_local: u32,
    ...
    fn clear_runtime_array_slot(&mut self, name: &str, index: u32) -> bool {
        let binding_name = self
            .resolve_runtime_array_binding_name(name)
            .unwrap_or_else(|| name.to_string());
        let Some(slot) = self.runtime_array_slot(&binding_name, index) else {
    ...
    fn emit_dynamic_runtime_array_slot_write(
        &mut self,
        name: &str,
        property: &Expression,
        value: &Expression,
    ...
    fn emit_runtime_array_push_from_local(
        &mut self,
        name: &str,
        value_local: u32,
        value_expression: &Expression,
    ...
    fn emit_runtime_array_push_with_length_local(
        &mut self,
        name: &str,
        length_local: u32,
        value_local: u32,
    ...
    fn tracked_direct_arguments_prefix_len(&self) -> u32 {
        let mut indices = self.arguments_slots.keys().copied().collect::<Vec<_>>();
        indices.sort_unstable();
    ...
    fn update_local_array_iterator_binding(&mut self, name: &str, value: &Expression) {
    ...
    fn update_local_iterator_step_binding(&mut self, name: &str, value: &Expression) {
    ...
    fn resolve_iterator_step_binding_from_expression(
        &self,
        expression: &Expression,
    ...
    fn update_local_array_binding(&mut self, name: &str, value: &Expression) {
        let Some(array_binding) = self.resolve_array_binding_from_expression(value) else {
            self.local_array_bindings.remove(name);
    ...
    fn update_local_object_binding(&mut self, name: &str, value: &Expression) {
    ...
    fn update_prototype_object_binding(&mut self, name: &str, value: &Expression) {
        let Some(object_binding) = self.resolve_object_binding_from_expression(value) else {
    ...
    fn update_object_binding_from_expression(&mut self, expression: &Expression) {
        let Expression::Call { callee, arguments } = expression else {
            return;
        };
        let Expression::Member { object, property } = callee.as_ref() else {
    ...
    fn resolve_static_call_result_expression(
        &self,
        callee: &Expression,
        arguments: &[CallArgument],
    ) -> Option<Expression> {
    ...
    fn resolve_static_call_result_expression_with_context(
        &self,
        callee: &Expression,
        arguments: &[CallArgument],
        current_function_name: Option<&str>,
    ...
    fn update_local_arguments_binding(&mut self, name: &str, value: &Expression) {
    ...
    fn resolve_descriptor_binding_from_expression(
        &self,
        expression: &Expression,
    ...
    fn update_local_descriptor_binding(&mut self, name: &str, value: &Expression) {
    ...
    fn update_global_property_descriptor_value(
        &mut self,
        name: &str,
        value_expression: &Expression,
    ) {
    ...
    fn ensure_global_property_descriptor_value(
        &mut self,
        name: &str,
        value_expression: &Expression,
        configurable: bool,
    ...
    fn instantiate_eval_global_function_property_descriptor(&mut self, name: &str) {
    ...
    fn update_local_value_binding(&mut self, name: &str, value: &Expression) {
    ...
    fn resolve_bound_alias_expression(&self, expression: &Expression) -> Option<Expression> {
    ...
    fn resolve_symbol_identity_expression(&self, expression: &Expression) -> Option<Expression> {
        let Expression::Identifier(name) = expression else {
            return None;
        };
        if self.lookup_identifier_kind(name) != Some(StaticValueKind::Symbol) {
    ...
    fn resolve_global_value_expression(&self, expression: &Expression) -> Option<Expression> {
        let mut visited = HashSet::new();
        self.resolve_global_value_expression_with_visited(expression, &mut visited)
    }

    fn resolve_global_value_expression_with_visited(
        &self,
        expression: &Expression,
    ...
    fn resolve_global_identifiers_in_expression(
        &self,
        expression: &Expression,
        visited: &mut HashSet<String>,
    ) -> Option<Expression> {
    ...
    fn emit_eval_comment_pattern(&mut self, argument: &Expression) -> DirectResult<bool> {
    ...
    fn emit_builtin_call_for_callee(
        &mut self,
        callee: &Expression,
        name: &str,
        arguments: &[CallArgument],
    ...
    fn emit_line_terminator_check(&mut self, code_expression: &Expression) -> DirectResult<()> {
    ...
    fn resolve_single_char_code_expression(&self, expression: &Expression) -> Option<Expression> {
        let resolved = self.resolve_bound_alias_expression(expression)?;
    ...
    fn resolve_char_code_argument(&self, argument: &Expression) -> Option<Expression> {
    ...
    fn resolve_hex_quad_numeric_expression(&self, expression: &Expression) -> Option<Expression> {
    ...
    fn collect_hex_digit_expressions(
        &self,
        expression: &Expression,
    ...
    fn emit_eval_call(&mut self, arguments: &[CallArgument]) -> DirectResult<bool> {
        let Some(argument) = arguments.first() else {
            self.push_i32_const(JS_UNDEFINED_TAG);
            return Ok(true);
        };
    ...
    fn emit_indirect_eval_call(&mut self, arguments: &[CallArgument]) -> DirectResult<bool> {
        let Some(argument) = arguments.first() else {
            self.push_i32_const(JS_UNDEFINED_TAG);
            return Ok(true);
        };
    ...
    fn instantiate_eval_global_functions(
        &mut self,
    ...
    fn instantiate_eval_var_bindings(
        &mut self,
        program: &Program,
    ...
    fn with_isolated_indirect_eval_state<T>(
        &mut self,
        callback: impl FnOnce(&mut Self) -> DirectResult<T>,
    ) -> DirectResult<T> {
    ...
    fn register_eval_global_function_local_bindings(&mut self, functions: &[FunctionDeclaration]) {
        for function in functions {
    ...
    fn instantiate_eval_local_functions(
        &mut self,
    ...
    fn eval_arguments_declaration_conflicts(&self, program: &Program) -> bool {
    ...
    fn eval_program_declares_var_collision_with_global_lexical(&self, program: &Program) -> bool {
        if !self.top_level_function || program.strict {
            return false;
        }
    ...
    fn eval_program_declares_var_collision_with_active_lexical(&self, program: &Program) -> bool {
        if program.strict {
            return false;
        }
    ...
    fn eval_program_declares_non_definable_global_function(&self, program: &Program) -> bool {
        if !self.top_level_function {
            return false;
        }
    ...
    fn parse_eval_program_in_current_function_context(&self, source: &str) -> Option<Program> {
        let current_function_name = self.current_user_function_name.as_deref()?;
        if self
    ...
    fn parse_eval_program_in_ordinary_function_context(&self, source: &str) -> Option<Program> {
    ...
    fn parse_eval_program_in_method_context(&self, source: &str) -> Option<Program> {
    ...
    fn prepare_eval_lexical_bindings(
        &mut self,
    ...
    fn register_bindings_skipping_eval_local_function_declarations(
        &mut self,
        statements: &[Statement],
        eval_local_function_declarations: &HashMap<String, String>,
    ) -> DirectResult<()> {
    ...
    fn rewrite_eval_lexical_statement(
        &self,
    ...
    fn rewrite_eval_lexical_expression(
        &self,
    ...
    fn infer_call_result_kind(&self, name: &str) -> Option<StaticValueKind> {
        match name {
    ...
    fn infer_typeof_operand_kind(&self, expression: &Expression) -> Option<StaticValueKind> {
        match expression {
            Expression::Identifier(name)
                if name == "NaN" && self.is_unshadowed_builtin_identifier(name) =>
            {
    ...
    fn is_identifier_bound(&self, name: &str) -> bool {
    ...
    fn emit_store_identifier_from_local(
        &mut self,
        name: &str,
        value_local: u32,
    ) -> DirectResult<()> {
    ...
    fn emit_store_identifier_value_local(
        &mut self,
        name: &str,
        value_expression: &Expression,
        value_local: u32,
    ...
    fn try_emit_destructuring_default_assign_statement(
        &mut self,
        name: &str,
        value: &Expression,
    ) -> DirectResult<bool> {
    ...
    fn note_identifier_numeric_kind(&mut self, name: &str) {
        if let Some((resolved_name, _)) = self.resolve_current_local_binding(name) {
            self.local_kinds
    ...
    fn emit_typeof_string_comparison(
        &mut self,
        left: &Expression,
        right: &Expression,
        op: BinaryOp,
    ...
    fn emit_runtime_typeof_tag_string_comparison(
        &mut self,
        left: &Expression,
        right: &Expression,
        op: BinaryOp,
    ...
    fn emit_hex_quad_string_comparison(
        &mut self,
        left: &Expression,
        right: &Expression,
        op: BinaryOp,
    ...
    fn lookup_identifier_kind(&self, name: &str) -> Option<StaticValueKind> {
    ...
    fn infer_value_kind(&self, expression: &Expression) -> Option<StaticValueKind> {
        match expression {
    ...
    fn emit_logical_and(&mut self, left: &Expression, right: &Expression) -> DirectResult<()> {
        let temp_local = self.allocate_temp_local();
        self.emit_numeric_expression(left)?;
        self.push_local_set(temp_local);
        self.push_local_get(temp_local);
    ...
    fn emit_typeof_print(&mut self, expression: &Expression) -> DirectResult<()> {
        if let Expression::Identifier(name) = expression
            && self.is_identifier_bound(name)
        {
    ...
    fn emit_runtime_typeof_tag(&mut self, expression: &Expression) -> DirectResult<()> {
        let value_local = self.allocate_temp_local();
        self.emit_numeric_expression(expression)?;
        self.push_local_set(value_local);
        self.emit_runtime_typeof_tag_from_local(value_local)
    ...
    fn emit_runtime_typeof_tag_from_local(&mut self, value_local: u32) -> DirectResult<()> {
        let result_local = self.allocate_temp_local();
        self.push_i32_const(JS_TYPEOF_NUMBER_TAG);
        self.push_local_set(result_local);
    ...
    fn emit_runtime_typeof_exact_match(
        &mut self,
        value_local: u32,
        result_local: u32,
        match_value: i32,
    ...
    fn emit_runtime_typeof_range_match(
        &mut self,
        value_local: u32,
        result_local: u32,
        start_inclusive: i32,
    ...
    fn emit_typeof_print_from_local(&mut self, type_tag_local: u32) -> DirectResult<()> {
    ...
    fn emit_print_string(&mut self, text: &str) -> DirectResult<()> {
        let (ptr, len) = self.module.intern_string(text.as_bytes().to_vec());
        self.push_i32_const(ptr as i32);
        self.push_i32_const(len as i32);
        self.push_call(WRITE_BYTES_FUNCTION_INDEX);
    ...
    fn emit_write_static_string_to_fd(&mut self, fd: i32, text: &str) -> DirectResult<()> {
        let (ptr, len) = self.module.intern_string(text.as_bytes().to_vec());
    ...
    fn emit_stderr_string(&mut self, text: &str) -> DirectResult<()> {
        self.emit_write_static_string_to_fd(2, text)
    }

    fn emit_uncaught_throw_report_from_locals(&mut self) -> DirectResult<()> {
        let matched_local = self.allocate_temp_local();
        self.push_i32_const(0);
        self.push_local_set(matched_local);
    ...
    fn emit_static_string_literal(&mut self, text: &str) -> DirectResult<()> {
        let (ptr, _) = self.module.intern_string(text.as_bytes().to_vec());
        self.push_i32_const(ptr as i32);
        Ok(())
    }

    fn emit_logical_or(&mut self, left: &Expression, right: &Expression) -> DirectResult<()> {
        let temp_local = self.allocate_temp_local();
        self.emit_numeric_expression(left)?;
        self.push_local_set(temp_local);
        self.push_local_get(temp_local);
    ...
    fn emit_exponentiate(&mut self, base: &Expression, exponent: &Expression) -> DirectResult<()> {
    ...
    fn push_binary_op(&mut self, op: BinaryOp) -> DirectResult<()> {
        let opcode = match op {
            BinaryOp::Add => 0x6a,
    ...
    fn lookup_local(&self, name: &str) -> DirectResult<u32> {
        Ok(self.locals.get(name).copied().unwrap_or(self.param_count))
    }

    fn emit_loose_comparison(&mut self, left: &Expression, right: &Expression) -> DirectResult<()> {
        self.emit_loose_number(left)?;
        self.emit_loose_number(right)?;
        Ok(())
    }

    fn emit_in_expression(&mut self, left: &Expression, right: &Expression) -> DirectResult<()> {
    ...
    fn expression_is_builtin_array_constructor(&self, expression: &Expression) -> bool {
        matches!(
            self.materialize_static_expression(expression),
    ...
    fn expression_is_known_array_value(&self, expression: &Expression) -> bool {
        if self
            .resolve_array_binding_from_expression(expression)
            .is_some()
        {
    ...
    fn emit_loose_number(&mut self, expression: &Expression) -> DirectResult<()> {
        match expression {
            Expression::Null => {
                self.push_i32_const(0);
                Ok(())
    ...
    fn find_labeled_loop_index(&self, label: &str) -> DirectResult<Option<usize>> {
        Ok(self
            .loop_stack
            .iter()
    ...
    fn break_hook_for_target(&self, break_target: usize) -> DirectResult<Option<Expression>> {
    ...
    fn find_labeled_break(&self, label: &str) -> DirectResult<Option<usize>> {
        Ok(self
            .break_stack
            .iter()
    ...
    fn allocate_temp_local(&mut self) -> u32 {
        let local_index = self.next_local_index;
        self.next_local_index += 1;
        local_index
    }

    fn push_control_frame(&mut self) -> usize {
        self.control_stack.push(());
        self.control_stack.len() - 1
    }

    fn pop_control_frame(&mut self) {
        self.control_stack.pop();
    }

    fn relative_depth(&self, target: usize) -> u32 {
    ...
    fn push_local_get(&mut self, local_index: u32) {
        self.instructions.push(0x20);
        push_u32(&mut self.instructions, local_index);
    }

    fn push_local_set(&mut self, local_index: u32) {
        self.instructions.push(0x21);
        push_u32(&mut self.instructions, local_index);
    }

    fn push_global_get(&mut self, global_index: u32) {
        self.instructions.push(0x23);
        push_u32(&mut self.instructions, global_index);
    }

    fn push_global_set(&mut self, global_index: u32) {
        self.instructions.push(0x24);
        push_u32(&mut self.instructions, global_index);
    }

    fn push_local_tee(&mut self, local_index: u32) {
    ...
    fn push_br(&mut self, relative_depth: u32) {
        self.instructions.push(0x0c);
        push_u32(&mut self.instructions, relative_depth);
    }

    fn push_br_if(&mut self, relative_depth: u32) {
        self.instructions.push(0x0d);
        push_u32(&mut self.instructions, relative_depth);
    }
}

fn collect_function_constructor_local_bindings(function: &FunctionDeclaration) -> HashSet<String> {
...
fn collect_declared_bindings_from_statements_recursive(
    statements: &[Statement],
) -> HashSet<String> {
...
fn collect_declared_bindings_from_statement(statement: &Statement, bindings: &mut HashSet<String>) {
    match statement {
        Statement::Block { body } | Statement::Labeled { body, .. } => {
            for statement in body {
...
fn eval_program_declares_var_arguments(program: &Program) -> bool {
    eval_statements_declare_var_arguments(&program.statements)
}

fn collect_direct_eval_lexical_binding_names(statements: &[Statement]) -> Vec<String> {
...
fn collect_referenced_binding_names_from_statements(statements: &[Statement]) -> HashSet<String> {
    let mut names = HashSet::new();
    for statement in statements {
...
fn collect_referenced_binding_names_from_expression(
    expression: &Expression,
    names: &mut HashSet<String>,
) {
    match expression {
...
fn collect_eval_var_names(program: &Program) -> HashSet<String> {
    let mut names = HashSet::new();
...
fn collect_eval_var_names_from_statements(statements: &[Statement], names: &mut HashSet<String>) {
    for statement in statements {
        match statement {
            Statement::Var { name, .. } => {
                names.insert(name.clone());
...
fn eval_statements_declare_var_arguments(statements: &[Statement]) -> bool {
    statements.iter().any(eval_statement_declares_var_arguments)
}

fn eval_statement_declares_var_arguments(statement: &Statement) -> bool {
    match statement {
...
fn collect_eval_local_function_declarations(
    statements: &[Statement],
...
fn is_eval_local_function_candidate(function: &FunctionDeclaration) -> bool {
    !function.register_global && function.name.starts_with("__ayy_fnstmt_")
}

fn collect_eval_local_function_declarations_from_statements(
    statements: &[Statement],
    local_function_names: &HashSet<String>,
...
fn eval_local_function_declaration_from_statement(
    statement: &Statement,
    local_function_names: &HashSet<String>,
...
fn scoped_binding_source_name(name: &str) -> Option<&str> {
...
fn is_eval_local_function_declaration_statement(
    statement: &Statement,
    declarations: &HashMap<String, String>,
) -> bool {
    let Statement::Let { name, value, .. } = statement else {
...
fn statement_references_user_function(statement: &Statement, names: &HashSet<String>) -> bool {
    match statement {
...
fn expression_references_user_function(expression: &Expression, names: &HashSet<String>) -> bool {
    match expression {
...
fn collect_implicit_globals_from_statements(
    statements: &[Statement],
    strict: bool,
...
fn collect_implicit_globals_from_statement(
    statement: &Statement,
    strict: bool,
    scope: &HashSet<String>,
    names: &mut BTreeSet<String>,
...
fn collect_implicit_globals_from_expression(
    expression: &Expression,
    strict: bool,
    scope: &HashSet<String>,
    names: &mut BTreeSet<String>,
...
fn user_function_runtime_value(user_function: &UserFunction) -> i32 {
...
fn internal_function_name_hint(function_name: &str) -> Option<&str> {
    function_name
        .rsplit_once("__name_")
...
fn function_display_name(function: &FunctionDeclaration) -> Option<String> {
    function
        .self_binding
        .clone()
...
fn builtin_function_runtime_value(name: &str) -> Option<i32> {
    match name {
...
fn is_non_definable_global_name(name: &str) -> bool {
    matches!(name, "NaN" | "Infinity" | "undefined")
}

fn is_reserved_js_runtime_value(integer: i64) -> bool {
...
fn f64_to_i32(value: f64) -> DirectResult<i32> {
...
fn parse_bigint_to_i32(value: &str) -> DirectResult<i32> {
...
fn parse_static_bigint_literal(value: &str) -> Option<StaticBigInt> {
    let literal = value.strip_suffix('n').unwrap_or(value);
...
fn parse_string_to_loose_i32(value: &str) -> DirectResult<i32> {
...
fn parse_typeof_tag_optional(value: &str) -> Option<i32> {
...
fn parse_typeof_tag(value: &str) -> DirectResult<i32> {
    match value.trim() {
...
fn parse_string_to_i32(value: &str) -> DirectResult<i32> {
...
mod tests {
    ...
    fn collects_parameter_object_bindings_for_repeated_getter_spread_calls() {
        ...
        let repeated_copy = compiler
            .infer_global_copy_data_properties_binding(&Expression::Identifier(
                "repeated".to_string(),
            ))
