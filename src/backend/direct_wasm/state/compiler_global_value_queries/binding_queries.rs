...
impl GlobalRuntimePrototypeQueryAccess for CompilerState {
...
impl GlobalIdentifierValueQueryAccess for CompilerState {
...
impl GlobalValueBindingQueryAccess for CompilerState {
    fn global_value_binding(&self, name: &str) -> Option<&Expression> {
        self.global_semantics.values.value_binding(name)
    }
}

impl GlobalObjectValueQueryAccess for CompilerState {
...
impl GlobalArrayValueQueryAccess for CompilerState {
...
impl GlobalArgumentsValueQueryAccess for CompilerState {
...
impl GlobalPropertyDescriptorQueryAccess for CompilerState {
