use super::super::{
    CompilerState, GlobalMemberAccessorQueryAccess, GlobalMemberCaptureQueryAccess,
    GlobalMemberFunctionQueryAccess, LocalFunctionBinding, MemberFunctionBindingKey,
};
use std::collections::BTreeMap;

impl GlobalMemberFunctionQueryAccess for CompilerState {
...
impl GlobalMemberCaptureQueryAccess for CompilerState {
...
impl GlobalMemberAccessorQueryAccess for CompilerState {
