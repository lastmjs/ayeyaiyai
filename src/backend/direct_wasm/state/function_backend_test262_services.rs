use crate::backend::direct_wasm::{
    Expression, FunctionCompilerBackend, ObjectValueBinding, Test262Realm,
    empty_object_value_binding, object_binding_set_property, test262_realm_eval_builtin_name,
    test262_realm_global_identifier,
};
...
impl<'a> FunctionCompilerBackend<'a> {
    ...
    pub(in crate::backend::direct_wasm) fn test262_realm_global_object_binding(
        ...
        self.test262.realm_global_object_binding(realm_id)
    }
    ...
    pub(in crate::backend::direct_wasm) fn test262_realm_mut(
        ...
        self.test262.realm_mut(realm_id)
    }
}
