...
impl<'a> FunctionCompiler<'a> {
    ...
    pub(in crate::backend::direct_wasm) fn register_eval_global_function_local_bindings(
        ...
        for function in functions {
            ...
            self.locals.insert(function.name.clone(), next_local_index);
            self.local_kinds
    ...
    pub(in crate::backend::direct_wasm) fn normalize_eval_scoped_bindings_to_source_names(
        ...
        let eval_local_function_names = program
            ...
            .map(|function| function.name.clone())
            .collect::<HashSet<_>>();
        let eval_local_function_bindings = collect_eval_local_function_declarations(
            &program.statements,
            &eval_local_function_names,
        )
        .into_keys()
        .collect::<HashSet<_>>();
    ...
    fn rewrite_eval_scoped_binding_name(
        &self,
        name: &mut String,
    ...
    fn rewrite_eval_scoped_captures_in_statement(
        &self,
    ...
    fn rewrite_eval_scoped_captures_in_expression(
        &self,
